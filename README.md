About certbot-dns-gehirn-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/certbot-dns-gehirn-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/certbot-dns-gehirn-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add certbot-dns-gehirn
# for installing globally
pixi global install certbot-dns-gehirn
```
...
It is possible to list all of the versions of `certbot-dns-gehirn` available on your platform:
...
```
pixi search certbot-dns-gehirn --channel conda-forge
```
